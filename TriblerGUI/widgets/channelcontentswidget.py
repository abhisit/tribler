...
from TriblerGUI.widgets.triblertablecontrollers import ContentTableViewController
...
class ChannelContentsWidget(widget_form, widget_class):
    ...
    def on_category_selector_changed(self, ind):
        self.model.category_filter = CATEGORY_SELECTOR_ITEMS[ind] if ind else None
        self.model.reset()
    ...
    def initialize_with_channel(self, channel_info):
        ...
        self.channel_preview_button.setHidden(channel_info['state'] in ('Complete', 'Legacy', 'Persona'))
